from rest_framework.generics import ListCreateAPIView,get_object_or_404,RetrieveAPIView,GenericAPIView,ListAPIView
...
class AllRoudes(ListAPIView):
    co=PlaceWay.objects.all().count()
    if co >=11:
        queryset=PlaceWay.objects.all()[10]
    else :
